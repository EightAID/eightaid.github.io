    ...
    <div className="site-shell min-h-screen text-stone-100">
      <header className="sticky top-0 z-20 border-b border-amber-300/20 bg-black/35 backdrop-blur-md">
        <div className="mx-auto flex w-[min(1100px,92%)] items-center justify-between py-4">
          <p className="text-sm font-semibold tracking-[0.2em] text-amber-100">DAISHOU PROJECT</p>
...
function HomePage() {
  return (
    <Layout>
      <section className="hero-panel overflow-hidden rounded-[28px] border border-amber-200/25 p-7 shadow-2xl md:p-10">
        <div className="grid gap-10 md:grid-cols-[1.2fr_1fr] md:items-end">
          ...
          <div className="rounded-3xl border border-amber-100/25 bg-black/35 p-6 backdrop-blur-sm">
            ...
            <h2 className="mt-2 text-2xl font-semibold text-amber-50">代償少女</h2>
            <p className="mt-3 text-sm leading-relaxed text-stone-200/90">
              カードバトルADV / 1人プレイ / Steam向け開発中
            </p>
      ...
      <section className="mt-12 rounded-2xl border border-amber-200/20 bg-black/30 p-6 md:p-8">
        <h2 className="text-2xl font-bold text-amber-50 md:text-3xl">作品概要</h2>
      ...
      <section id="gallery" className="mt-12">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <figure key={item.src} className="overflow-hidden rounded-2xl border border-amber-200/20 bg-black/30">
      ...
      <section id="movie" className="mt-12 grid gap-6 md:grid-cols-[1.2fr_1fr] md:items-center">
        ...
        <div className="rounded-2xl border border-amber-200/20 bg-black/30 p-6">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-4 inline-block rounded-full border border-amber-100/30 px-4 py-2 text-sm font-semibold text-amber-50 transition hover:bg-amber-100/15"
          >
            YouTubeで見る
          </a>
        </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-2xl font-semibold text-amber-50">{member.name}</h2>
                </div>
              </div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-5 inline-block rounded-full border border-amber-100/30 px-4 py-2 text-sm font-semibold text-amber-50 transition hover:bg-amber-100/15"
              >
                Xを見る
              </a>
            </article>
