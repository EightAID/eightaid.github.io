...
const products = defineCollection({
  ...
  schema: z.object({
    ...
    music: z.object({
      composer: z.string(),
      composerImage: z.string(),
      composerBirthday: z.string(),
      composerBloodType: z.string(),
      composerZodiac: z.string(),
      composerUrl: linkSchema,
      composerXUrl: linkSchema,
      composerBoothUrl: linkSchema,
      profile: z.string(),
      youtubeId: z.string(),
      url: linkSchema,
      title: z.string(),
